...
local ICON_DIR = gfs.get_configuration_dir() .. "icons/bar/"
...
local brightness_widget = {}
    ...
    local path_to_icon = ICON_DIR .. 'brightness.svg'
    local timeout = 100
    local step = 5
    local base = 20
    local current_level = 43 -- current brightness value
    local tooltip = false
    local rmb_set_max =false
